...
Use `art-plasma-ball-no-base` to display just the glass sphere without the stand. Clicking the ball toggles the plasma effect.

<ComponentShowcase
  title="Plasma Ball (No Base)"
  code={`<div class="art-plasma-ball art-plasma-ball-no-base">
  <input class="switcher" type="checkbox" checked />
  <div class="glassball">
    <div class="electrode"></div>
    <div class="rays">
...
| Class | Description |
|-------|-------------|
| `.art-plasma-ball` | Base plasma ball with interactive toggle and stand |
| `.art-plasma-ball-no-base` | Hides the stand and switch; click the ball to toggle |
