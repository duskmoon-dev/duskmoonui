...
@import "@duskmoon-dev/core/components/footer";
@import "@duskmoon-dev/core/components/hero";
@import "@duskmoon-dev/core/components/indicator";
@import "@duskmoon-dev/core/components/join";
@import "@duskmoon-dev/core/components/mask";
@import "@duskmoon-dev/core/components/sidebar-layout";
@import "@duskmoon-dev/core/components/stack";

/* Navigation */
@import "@duskmoon-dev/core/components/bottom-navigation";
@import "@duskmoon-dev/core/components/breadcrumbs";
...
@import "@duskmoon-dev/core/components/menu";
@import "@duskmoon-dev/core/components/navbar";
@import "@duskmoon-dev/core/components/nested-menu";
@import "@duskmoon-dev/core/components/pagination";
@import "@duskmoon-dev/core/components/stepper";
@import "@duskmoon-dev/core/components/tabs";
...
| Bottom Navigation (Dock) | `@duskmoon-dev/core/components/bottom-navigation` | ~6KB |
| Bottomsheet | `@duskmoon-dev/core/components/bottomsheet` | ~7KB |
| Breadcrumbs | `@duskmoon-dev/core/components/breadcrumbs` | ~5KB |
...
| Dropdown | `@duskmoon-dev/core/components/dropdown` | under 4KB |
| Drawer | `@duskmoon-dev/core/components/drawer` | ~8KB |
| FAB / Speed Dial | `@duskmoon-dev/core/components/fab` | under 4KB |
| File Upload | `@duskmoon-dev/core/components/file-upload` | ~7KB |
| Footer | `@duskmoon-dev/core/components/footer` | under 2KB |
| Form | `@duskmoon-dev/core/components/form` | ~9KB |
| Hero | `@duskmoon-dev/core/components/hero` | under 2KB |
| Indicator | `@duskmoon-dev/core/components/indicator` | under 2KB |
| Input | `@duskmoon-dev/core/components/input` | ~6KB |
| Join | `@duskmoon-dev/core/components/join` | under 2KB |
| Link | `@duskmoon-dev/core/components/link` | under 2KB |
| List | `@duskmoon-dev/core/components/list` | ~4KB |
| Mask | `@duskmoon-dev/core/components/mask` | under 2KB |
| Modal | `@duskmoon-dev/core/components/modal` | ~6KB |
| Megamenu | `@duskmoon-dev/core/components/megamenu` | under 5KB |
| Menu | `@duskmoon-dev/core/components/menu` | under 4KB |
| Navigation | `@duskmoon-dev/core/components/navigation` | ~8KB |
| Navbar | `@duskmoon-dev/core/components/navbar` | ~6KB |
| Nested Menu | `@duskmoon-dev/core/components/nested-menu` | ~7KB |
| Pagination | `@duskmoon-dev/core/components/pagination` | ~6KB |
...
| Sidebar Layout | `@duskmoon-dev/core/components/sidebar-layout` | under 3KB |
| Snackbar | `@duskmoon-dev/core/components/snackbar` | ~7KB |
| Stack | `@duskmoon-dev/core/components/stack` | under 2KB |
| Stepper (Steps) | `@duskmoon-dev/core/components/stepper` | ~7KB |
| Switch | `@duskmoon-dev/core/components/switch` | ~7KB |
| Swap | `@duskmoon-dev/core/components/swap` | under 3KB |
| Table | `@duskmoon-dev/core/components/table` | ~4KB |
| Tabs | `@duskmoon-dev/core/components/tabs` | ~6KB |
| Theme Controller | `@duskmoon-dev/core/components/theme-controller` | under 6KB |
...
FAB provides placement and action-group layout but deliberately reuses Button appearance. Import both standalone styles for FAB examples:
