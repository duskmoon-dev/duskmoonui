...
<ComponentShowcase title="Native non-modal Drawer" code={`<button type="button" class="btn" command="toggle-popover" commandfor="demo-drawer-popover">Open drawer</button>
<aside id="demo-drawer-popover" class="drawer drawer-left" popover="auto" aria-labelledby="demo-drawer-title">
  <div class="drawer-header">
    <h2 id="demo-drawer-title" class="drawer-title">Quick actions</h2>
    <button type="button" class="drawer-close" command="hide-popover" commandfor="demo-drawer-popover" aria-label="Close drawer" autofocus>×</button>
  </div>
...
<ComponentShowcase title="Native modal Drawer" code={`<button type="button" class="btn btn-primary" command="show-modal" commandfor="demo-drawer-modal">Open modal drawer</button>
<dialog id="demo-drawer-modal" class="drawer drawer-left" closedby="any" aria-labelledby="demo-drawer-modal-title">
  <div class="drawer-header">
    <h2 id="demo-drawer-modal-title" class="drawer-title">Review changes</h2>
    <button type="button" class="drawer-close" command="close" commandfor="demo-drawer-modal" aria-label="Close drawer" autofocus>×</button>
  </div>
  <div class="drawer-body">
...
## Legacy class-controlled examples

The following examples retain the existing class API. Applications using it must manage focus, Escape, and dismissal themselves. Prefer the native examples above for overlays.
...
- [Navbar](/duskmoonui/docs/en/components/navbar/) - Top navigation
- [Menu](/duskmoonui/docs/en/components/menu/) - Dropdown menus
- [Bottom Navigation](/duskmoonui/docs/en/components/bottom-navigation/) - Mobile bottom navigation
