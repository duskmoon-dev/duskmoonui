...
<ComponentShowcase title="Fixed App Bar (demo without positioning)" code={`<!-- In production: add appbar-fixed class -->
<header class="appbar">
  <div class="appbar-title">
...
<ComponentShowcase title="Sticky App Bar (demo without positioning)" code={`<!-- In production: add appbar-sticky class -->
<header class="appbar">
  <div class="appbar-title">
...
<ComponentShowcase title="App Bar with Search" code={`<header class="appbar">
  ...
  <input type="search" name="appbar-search" class="appbar-search" placeholder="Search..." aria-label="Search" />
  <div class="appbar-trailing">
...
<ComponentShowcase title="Bottom App Bar (demo without positioning)" code={`<!-- In production: appbar-bottom uses position: fixed -->
<footer class="appbar">
  <div class="appbar-leading">
    <button class="appbar-action" aria-label="Menu">☰</button>
  </div>
