...
The indeterminate state is set via JavaScript:

<ComponentShowcase title="Indeterminate Checkbox" code={`<input type="checkbox" class="checkbox" id="indeterminate-demo" />
