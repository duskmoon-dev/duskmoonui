...
<script>
  ...
  bioTextarea.addEventListener('input', () => {
    ...
    charCount.parentElement.classList.toggle('textarea-counter-exceeded', count > 200);
  });
</script>
```
...
<script>
  ...
  feedbackTextarea.addEventListener('input', () => {
    ...
    feedbackCount.parentElement.classList.toggle('textarea-counter-exceeded', count > 500);
  });
</script>
```
...
<div class="textarea-container">
  ...
  <textarea
    id="comment"
    class="textarea textarea-auto-resize textarea-resize-none"
