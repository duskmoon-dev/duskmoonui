...
### Status Variants
<ComponentShowcase title="Status Variants" code={`<textarea class="textarea textarea-info" placeholder="Info focus color..."></textarea>
<textarea class="textarea textarea-success" placeholder="Success focus color..."></textarea>
<textarea class="textarea textarea-warning" placeholder="Warning focus color..."></textarea>
<textarea class="textarea textarea-error" placeholder="Error focus color..."></textarea>`}>
  <textarea class="textarea textarea-info" placeholder="Info focus color..."></textarea>
  <textarea class="textarea textarea-success" placeholder="Success focus color..."></textarea>
  <textarea class="textarea textarea-warning" placeholder="Warning focus color..."></textarea>
  <textarea class="textarea textarea-error" placeholder="Error focus color..."></textarea>
</ComponentShowcase>
...
<ComponentShowcase title="Ghost Textarea" code={`<textarea class="textarea textarea-ghost" placeholder="Ghost textarea (no border)..."></textarea>`}>
  <textarea class="textarea textarea-ghost" placeholder="Ghost textarea (no border)..."></textarea>
</ComponentShowcase>
