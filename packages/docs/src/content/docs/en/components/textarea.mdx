...
<ComponentShowcase title="Basic Textarea" code={`<textarea name="message" class="textarea" placeholder="Enter your message..." aria-label="Message"></textarea>`} />
...
<ComponentShowcase title="Outlined Textarea" code={`<textarea name="outlined-textarea" class="textarea textarea-outlined" placeholder="Outlined textarea..." aria-label="Outlined textarea"></textarea>`} />

### Filled Textarea

Filled textareas have a solid background with a bottom border, providing a more subtle appearance.

<ComponentShowcase title="Filled Textarea" code={`<textarea name="filled-textarea" class="textarea textarea-filled" placeholder="Filled textarea..." aria-label="Filled textarea"></textarea>`} />

## Color Variants

Focus colors can be customized using color variants:

<ComponentShowcase title="Color Variants" code={`<textarea name="primary-textarea" class="textarea textarea-primary" placeholder="Primary focus color..." aria-label="Primary textarea"></textarea>
<textarea name="secondary-textarea" class="textarea textarea-secondary" placeholder="Secondary focus color..." aria-label="Secondary textarea"></textarea>
<textarea name="tertiary-textarea" class="textarea textarea-tertiary" placeholder="Tertiary focus color..." aria-label="Tertiary textarea"></textarea>`} />

### Status Variants
<ComponentShowcase title="Status Variants" code={`<textarea name="info-textarea" class="textarea textarea-info" placeholder="Info focus color..." aria-label="Info textarea"></textarea>
<textarea name="success-textarea" class="textarea textarea-success" placeholder="Success focus color..." aria-label="Success textarea"></textarea>
<textarea name="warning-textarea" class="textarea textarea-warning" placeholder="Warning focus color..." aria-label="Warning textarea"></textarea>
<textarea name="error-textarea" class="textarea textarea-error" placeholder="Error focus color..." aria-label="Error textarea"></textarea>`}>
  <textarea name="info-textarea" class="textarea textarea-info" placeholder="Info focus color..." aria-label="Info textarea"></textarea>
  <textarea name="success-textarea" class="textarea textarea-success" placeholder="Success focus color..." aria-label="Success textarea"></textarea>
  <textarea name="warning-textarea" class="textarea textarea-warning" placeholder="Warning focus color..." aria-label="Warning textarea"></textarea>
  <textarea name="error-textarea" class="textarea textarea-error" placeholder="Error focus color..." aria-label="Error textarea"></textarea>
</ComponentShowcase>
...
<ComponentShowcase title="Textarea Sizes" code={`<textarea name="small-textarea" class="textarea textarea-sm" placeholder="Small textarea..." aria-label="Small textarea"></textarea>
<textarea name="medium-textarea" class="textarea" placeholder="Medium textarea (default)..." aria-label="Medium textarea"></textarea>
<textarea name="large-textarea" class="textarea textarea-lg" placeholder="Large textarea..." aria-label="Large textarea"></textarea>`} />
...
<textarea name="vertical-resize-textarea" class="textarea textarea-resize-vertical" placeholder="Resize vertically..." aria-label="Vertically resizable textarea"></textarea>

<!-- No resize -->
<textarea name="fixed-textarea" class="textarea textarea-resize-none" placeholder="Cannot be resized..." aria-label="Fixed size textarea"></textarea>

<!-- Horizontal resize -->
<textarea name="horizontal-resize-textarea" class="textarea textarea-resize-horizontal" placeholder="Resize horizontally..." aria-label="Horizontally resizable textarea"></textarea>

<!-- Both directions -->
<textarea name="both-resize-textarea" class="textarea textarea-resize-both" placeholder="Resize in any direction..." aria-label="Resizable textarea"></textarea>`} />

## Auto-Resize

All `.textarea` elements use native `field-sizing: content` by default, so supporting browsers automatically adjust their height based on content. Add `.textarea-auto-resize` for a compact textarea without a manual resize handle or visible overflow:

<ComponentShowcase title="Auto-Resize Textarea" code={`<textarea name="auto-resize-textarea" class="textarea textarea-auto-resize" placeholder="Grows with content..." aria-label="Auto-resizing textarea"></textarea>`} />

For browsers without `field-sizing` support, use JavaScript as a fallback:
...
<ComponentShowcase title="Disabled State" code={`<textarea name="disabled-textarea" class="textarea" disabled placeholder="Disabled textarea..." aria-label="Disabled textarea"></textarea>`} />

### Read-only State

Display-only content:

<ComponentShowcase title="Read-only State" code={`<textarea name="readonly-textarea" class="textarea" readonly aria-label="Read-only textarea">This content cannot be edited</textarea>`} />

## Full Width

Ensure textarea spans the full container width:

<ComponentShowcase title="Full Width Textarea" code={`<textarea name="full-width-textarea" class="textarea textarea-full" placeholder="Full width textarea..." aria-label="Full width textarea"></textarea>`} />
...
<textarea name="interest" class="textarea" placeholder="e.g., I'm interested in learning more about..." aria-label="Interest"></textarea>

<!-- Bad: Using placeholder as label -->
<textarea name="comments" class="textarea" placeholder="Comments*" aria-label="Comments"></textarea>`} />
...
<ComponentShowcase title="Labels and Helper Text" code={`<div class="textarea-container">
  <label class="textarea-label" for="project-description">Project Description</label>
  <textarea id="project-description" name="project-description" class="textarea" placeholder="Describe your project..."></textarea>
...
<textarea name="quick-feedback" class="textarea textarea-sm" rows="2" placeholder="Quick feedback..." aria-label="Quick feedback"></textarea>

<!-- Long-form content -->
<textarea name="article" class="textarea textarea-lg" rows="8" placeholder="Write your article..." aria-label="Article"></textarea>`} />
...
| `.textarea-auto-resize` | Compact auto-resize styling; use a JS fallback in browsers without `field-sizing` support |
...
<textarea name="combined-textarea" class="textarea textarea-filled textarea-tertiary textarea-lg textarea-error" aria-label="Combined textarea styles">
</textarea>

<!-- Small outlined textarea with no resize -->
<textarea name="compact-textarea" class="textarea textarea-outlined textarea-sm textarea-resize-none" aria-label="Compact textarea">
</textarea>

<!-- Auto-resize primary textarea with success state -->
<textarea name="auto-resize-success-textarea" class="textarea textarea-primary textarea-auto-resize textarea-success" aria-label="Successful auto-resizing textarea">
</textarea>`} />

## Ghost Variant

<ComponentShowcase title="Ghost Textarea" code={`<textarea name="ghost-textarea" class="textarea textarea-ghost" placeholder="Ghost textarea (no border)..." aria-label="Ghost textarea"></textarea>`}>
  <textarea name="ghost-textarea" class="textarea textarea-ghost" placeholder="Ghost textarea (no border)..." aria-label="Ghost textarea"></textarea>
</ComponentShowcase>
