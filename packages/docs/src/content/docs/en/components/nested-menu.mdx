...
<ComponentShowcase title="Disabled Items" code={`<ul class="nested-menu">
  ...
  <li class="disabled"><button type="button" disabled>Billing (coming soon)</button></li>
  <li class="disabled"><button type="button" disabled>API Keys (coming soon)</button></li>
</ul>`} />
...
- Use a disabled `button` for unavailable actions. For an unavailable destination, render non-actionable text; `aria-disabled` on a link does not prevent navigation by itself.
...
<ComponentShowcase title="Accessible Navigation" code={`<nav aria-label="Documentation sidebar">
  <ul class="nested-menu">
    ...
    <li class="disabled"><button type="button" disabled>Advanced (coming soon)</button></li>
  </ul>
</nav>`} />
