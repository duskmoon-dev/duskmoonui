...
<ComponentShowcase title="Multi-Select with Search" code={`<div class="multi-select">
  <button class="multi-select-trigger" popovertarget="multi-select-search">
    <div class="multi-select-tags">
      ...
      <input type="text" name="multi-select-filter" class="multi-select-input" placeholder="Search..." aria-label="Filter selected options" />
    </div>
    <svg class="multi-select-arrow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
    </svg>
  ...
  <div class="multi-select-dropdown" id="multi-select-search" popover="auto">
    <div class="multi-select-search">
      <input type="text" name="multi-select-search" class="multi-select-search-input" placeholder="Search options..." aria-label="Search options" />
    </div>
    <div class="multi-select-options">
      <div class="multi-select-option multi-select-option-selected">
        <span class="multi-select-option-checkbox">✓</span>
...
<ComponentShowcase title="Error State" code={`<div class="form-group">
  <span class="form-label form-label-required">Skills</span>
...
<ComponentShowcase title="Color Variants" code={`<div class="multi-select multi-select-primary">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-primary">Primary Multi-Select</button>
</div>
<div class="multi-select multi-select-secondary">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-secondary">Secondary Multi-Select</button>
</div>
<div class="multi-select multi-select-tertiary">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-tertiary">Tertiary Multi-Select</button>
</div>
<div class="multi-select multi-select-info">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-info">Info Multi-Select</button>
</div>
<div class="multi-select multi-select-success">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-success">Success Multi-Select</button>
</div>
<div class="multi-select multi-select-warning">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-warning">Warning Multi-Select</button>
</div>
<div class="multi-select multi-select-error">
  <button class="multi-select-trigger" popovertarget="demo-ms-color-error">Error Multi-Select</button>
</div>`}>
  <div class="flex flex-col gap-2">
    <div class="multi-select multi-select-primary">
      <button class="multi-select-trigger">Primary Multi-Select</button>
    </div>
    <div class="multi-select multi-select-success">
      <button class="multi-select-trigger">Success Multi-Select</button>
    </div>
    <div class="multi-select multi-select-error">
      <button class="multi-select-trigger">Error Multi-Select</button>
    </div>
  </div>
</ComponentShowcase>
...
<ComponentShowcase title="Ghost Multi-Select" code={`<div class="multi-select multi-select-ghost">
  <button class="multi-select-trigger">Ghost Multi-Select (no border)</button>
</div>`}>
  <div class="multi-select multi-select-ghost">
    <button class="multi-select-trigger">Ghost Multi-Select (no border)</button>
  </div>
</ComponentShowcase>
