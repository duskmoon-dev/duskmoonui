...
<ComponentShowcase title="Filled Rating" code={`<div class="rating">
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item">☆</span>
  <span class="rating-item">☆</span>
...
<ComponentShowcase title="Primary Rating" code={`<div class="rating rating-primary">
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item">☆</span>
...
### Info
<ComponentShowcase title="Info Rating" code={`<div class="rating rating-info">
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item">★</span>
...
### Success
<ComponentShowcase title="Success Rating" code={`<div class="rating rating-success">
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
  <span class="rating-item filled">★</span>
...
### Error
<ComponentShowcase title="Error Rating" code={`<div class="rating rating-error">
  <span class="rating-item filled">★</span>
  <span class="rating-item">★</span>
  <span class="rating-item">★</span>
  <span class="rating-item">★</span>
  ...
  return (
    <div className={classes}>
      {Array.from({ length: max }, (_, i) => (
        <span
          key={i}
          className={`rating-item ${i < value ? 'filled' : ''}`}
...
<template>
  <div :class="classes">
    <span
      v-for="(_, i) in max"
      :key="i"
      :class="['rating-item', { 'filled': i < value }]"
      @click="handleClick(i)"
      :tabindex="readonly ? -1 : 0"
      :role="readonly ? undefined : 'radio'"
      :aria-label="`${i + 1} star${i > 0 ? 's' : ''}`"
...
| `.filled` | Filled/selected rating item (combine with `.rating-item`) |
...
- [Button](/duskmoonui/docs/en/components/button/) - Action triggers
- [Badge](/duskmoonui/docs/en/components/badge/) - Status indicators
- [Chip](/duskmoonui/docs/en/components/chip/) - Compact elements
