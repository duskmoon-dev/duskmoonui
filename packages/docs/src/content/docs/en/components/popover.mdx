...
<ComponentShowcase title="Basic Popover" code={`<button class="btn btn-primary" popovertarget="basic-popover">Show Popover</button>
<div class="popover" id="basic-popover" popover>
...
Native HTML popovers render in the top layer and are centered by default. For custom positioning relative to the trigger, use CSS anchor positioning or a positioning library like [Floating UI](https://floating-ui.com/).
...
<ComponentShowcase title="Small Popover" code={`<button class="btn btn-primary" popovertarget="small-popover">Small Popover</button>
<div class="popover popover-sm" id="small-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Default Popover" code={`<button class="btn btn-primary" popovertarget="default-popover">Default Popover</button>
<div class="popover" id="default-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Large Popover" code={`<button class="btn btn-primary" popovertarget="large-popover">Large Popover</button>
<div class="popover popover-lg" id="large-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Primary Popover" code={`<button class="btn btn-primary" popovertarget="demo-primary">Primary Popover</button>
<div class="popover popover-primary" id="demo-primary" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Secondary Popover" code={`<button class="btn btn-secondary" popovertarget="demo-secondary">Secondary Popover</button>
<div class="popover popover-secondary" id="demo-secondary" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Tertiary Popover" code={`<button class="btn btn-tertiary" popovertarget="demo-tertiary">Tertiary Popover</button>
<div class="popover popover-tertiary" id="demo-tertiary" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Surface Variant" code={`<button class="btn btn-outlined" popovertarget="demo-surface">Surface Popover</button>
<div class="popover popover-surface-highest" id="demo-surface" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Popover with Header" code={`<button class="btn btn-primary" popovertarget="header-popover">Popover with Header</button>
<div class="popover" id="header-popover" popover>
...
<ComponentShowcase title="Popover with Footer" code={`<button class="btn btn-primary" popovertarget="footer-popover">Popover with Footer</button>
<div class="popover" id="footer-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Complete Popover Example" code={`<button class="btn btn-primary" popovertarget="complete-popover">Complete Popover</button>
<div class="popover popover-lg" id="complete-popover" popover>
...
<ComponentShowcase title="No Arrow" code={`<button class="btn btn-primary" popovertarget="no-arrow-popover">No Arrow</button>
<div class="popover popover-no-arrow" id="no-arrow-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Interactive Popover" code={`<button class="btn btn-primary" popovertarget="interactive-popover">Interactive Popover</button>
<div class="popover popover-interactive" id="interactive-popover" popover="manual">
  <div class="popover-header">
...
Use the `popover` attribute on the popover element and `popovertarget` on the trigger button:

<ComponentShowcase title="Native Popover" code={`<button class="btn btn-primary" popovertarget="native-popover">
  Open Native Popover
</button>
<div class="popover" id="native-popover" popover>
  <div class="popover-body">
...
<ComponentShowcase title="Native Popover with Header and Footer" code={`<button class="btn btn-primary" popovertarget="rich-native-popover">
  Rich Content Popover
</button>
<div class="popover popover-lg" id="rich-native-popover" popover>
  <div class="popover-header">
...
<ComponentShowcase title="Native Popover Colors" code={`<div class="flex gap-2 flex-wrap">
  <button class="btn btn-primary" popovertarget="native-primary">Primary</button>
  <div class="popover popover-primary" id="native-primary" popover>
    <div class="popover-body">Primary themed native popover.</div>
  </div>

  <button class="btn btn-secondary" popovertarget="native-secondary">Secondary</button>
  <div class="popover popover-secondary" id="native-secondary" popover>
    <div class="popover-body">Secondary themed native popover.</div>
  </div>

  <button class="btn btn-tertiary" popovertarget="native-tertiary">Tertiary</button>
  <div class="popover popover-tertiary" id="native-tertiary" popover>
...
<ComponentShowcase title="Manual Native Popover" code={`<button class="btn btn-primary" popovertarget="manual-popover">
  Open Manual Popover
</button>
<div class="popover" id="manual-popover" popover="manual">
  <div class="popover-header">
...
<ComponentShowcase title="Modal-style Native Popover" code={`<button class="btn btn-primary" popovertarget="modal-popover">
  Open Modal Popover
</button>
<div class="popover popover-modal popover-lg" id="modal-popover" popover>
  <div class="popover-header">
