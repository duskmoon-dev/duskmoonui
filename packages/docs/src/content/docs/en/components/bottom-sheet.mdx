...
<ComponentShowcase title="No Padding" code={`<div class="bottom-sheet bottom-sheet-no-padding bottom-sheet-show">
  <div class="bottom-sheet-handle"></div>
  <div class="bottom-sheet-body">
    <img src="https://picsum.photos/seed/bottom-sheet/1200/480" alt="Mountain landscape" class="w-full" />
    <div class="p-4">
  ...
  <div class="bottom-sheet-body">
    ...
    <div class="mb-6">
      ...
      <div class="flex gap-2">
        <input type="number" name="minimum-price" placeholder="Min" aria-label="Minimum price" class="input flex-1" />
        <input type="number" name="maximum-price" placeholder="Max" aria-label="Maximum price" class="input flex-1" />
      </div>
    </div>
  </div>
  <div class="bottom-sheet-footer">
