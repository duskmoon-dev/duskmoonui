...
### Info
<ComponentShowcase title="Info Date Picker" code={`<div class="datepicker datepicker-info">
  <input name="primary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Primary date picker" />
</div>`}>
  <div class="datepicker datepicker-info">
    <input name="primary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Primary date picker" />
  </div>
</ComponentShowcase>

### Success
<ComponentShowcase title="Success Date Picker" code={`<div class="datepicker datepicker-success">
  <input name="secondary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Secondary date picker" />
</div>`}>
  <div class="datepicker datepicker-success">
    <input name="secondary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Secondary date picker" />
  </div>
</ComponentShowcase>

### Warning
<ComponentShowcase title="Warning Date Picker" code={`<div class="datepicker datepicker-warning">
  <input name="tertiary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Tertiary date picker" />
</div>`}>
  <div class="datepicker datepicker-warning">
    <input name="tertiary-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Tertiary date picker" />
  </div>
</ComponentShowcase>

### Error
<ComponentShowcase title="Error Date Picker" code={`<div class="datepicker datepicker-error">
  <input name="error-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Error date picker" />
</div>`}>
  <div class="datepicker datepicker-error">
    <input name="error-datepicker" class="datepicker-input" placeholder="Pick a date..." aria-label="Error date picker" />
  </div>
</ComponentShowcase>
...
<ComponentShowcase title="Ghost Date Picker" code={`<div class="datepicker datepicker-ghost">
  <input name="ghost-datepicker" class="datepicker-input" placeholder="Ghost date picker (no border)..." aria-label="Ghost date picker" />
</div>`}>
  <div class="datepicker datepicker-ghost">
    <input name="ghost-datepicker" class="datepicker-input" placeholder="Ghost date picker (no border)..." aria-label="Ghost date picker" />
  </div>
</ComponentShowcase>
