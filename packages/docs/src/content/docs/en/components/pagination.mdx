...
<ComponentShowcase title="Basic Pagination" code={`<nav class="pagination" aria-label="Pagination">
...
<ComponentShowcase title="Disabled Page Item" code={`<nav class="pagination">
  <a href="#" class="pagination-item">1</a>
  <a href="#" class="pagination-item pagination-item-active">2</a>
  <span class="pagination-item pagination-item-disabled" aria-disabled="true">3</span>
  <a href="#" class="pagination-item">4</a>
</nav>`} />

For controls that submit an application-owned page change, use real buttons and `disabled`. For link pagination, omit `href` or render non-actionable text at an unavailable boundary; `pointer-events` styling alone is not a disabled behavior.

## Join Composition

Use the independent Join primitive when pagination should read as one connected control. This is additive and does not replace `.pagination`:

<ComponentShowcase title="Pagination composed with Join" code={`<nav aria-label="Pagination">
  <div class="join">
    <a class="join-item pagination-prev" href="?page=1">Previous</a>
    <a class="join-item pagination-item" href="?page=1">1</a>
    <a class="join-item pagination-item" href="?page=2" aria-current="page">2</a>
    <a class="join-item pagination-item" href="?page=3">3</a>
    <a class="join-item pagination-next" href="?page=3">Next</a>
  </div>
</nav>`} />
...
<ComponentShowcase title="Pagination with Page Jump" code={`<nav class="pagination">
  ...
  <span class="pagination-input">
    <span>Go to</span>
    <input type="number" name="page-number" min="1" max="10" value="2" aria-label="Page number" />
  </span>
  <button class="pagination-next">Next</button>
</nav>`} />
