...
<ComponentShowcase title="Color Variants" code={`<div class="autocomplete autocomplete-primary">
  <input class="autocomplete-input" placeholder="Primary autocomplete..." />
...
<div class="autocomplete autocomplete-secondary">
  <input class="autocomplete-input" placeholder="Secondary autocomplete..." />
</div>
<div class="autocomplete autocomplete-tertiary">
  <input class="autocomplete-input" placeholder="Tertiary autocomplete..." />
</div>
<div class="autocomplete autocomplete-info">
  <input class="autocomplete-input" placeholder="Info autocomplete..." />
</div>
<div class="autocomplete autocomplete-success">
  <input class="autocomplete-input" placeholder="Success autocomplete..." />
</div>
<div class="autocomplete autocomplete-warning">
  <input class="autocomplete-input" placeholder="Warning autocomplete..." />
</div>
<div class="autocomplete autocomplete-error">
  <input class="autocomplete-input" placeholder="Error autocomplete..." />
</div>`}>
...
<ComponentShowcase title="Ghost Autocomplete" code={`<div class="autocomplete autocomplete-ghost">
  <input class="autocomplete-input" placeholder="Ghost autocomplete (no border)..." />
</div>`}>
