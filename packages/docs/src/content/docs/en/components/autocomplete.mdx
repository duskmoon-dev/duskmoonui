...
<ComponentShowcase title="Multiple Selection with Chips" code={`<div class="autocomplete">
  ...
  <div class="autocomplete-input-wrapper">
    <input
      type="text"
      name="additional-language-autocomplete"
      class="autocomplete-input"
...
<ComponentShowcase title="No Options State" code={`<div class="autocomplete">
  <div class="autocomplete-input-wrapper">
    <input
      type="text"
      name="empty-result-autocomplete"
      class="autocomplete-input"
      placeholder="Search..."
      aria-label="Search options with no results"
      value="xyz123"
      aria-autocomplete="list"
    />
    <button class="autocomplete-toggle" aria-label="Toggle dropdown">▼</button>
...
<ComponentShowcase title="Focused Option" code={`<div class="autocomplete">
  <div class="autocomplete-input-wrapper">
    <input
      type="text"
      name="focused-autocomplete"
      class="autocomplete-input"
      placeholder="Navigate with arrows..."
      aria-label="Keyboard navigation example"
      aria-autocomplete="list"
      aria-activedescendant="focused-option-2"
    />
    <button class="autocomplete-toggle" aria-label="Toggle dropdown">▼</button>
  </div>
  <div class="autocomplete-dropdown autocomplete-dropdown-open">
    <ul class="autocomplete-options" role="listbox">
      <li role="option" id="focused-option-1" class="autocomplete-option">Option 1</li>
      <li role="option" id="focused-option-2" class="autocomplete-option autocomplete-option-focused">Option 2</li>
      <li role="option" id="focused-option-3" class="autocomplete-option">Option 3</li>
    </ul>
  </div>
</div>`} />
...
<ComponentShowcase title="Accessible Autocomplete" code={`<div class="autocomplete">
  ...
  >
    <ul class="autocomplete-options">
      <li role="option" id="country-option-1" class="autocomplete-option">United States</li>
      <li role="option" id="country-option-2" class="autocomplete-option">Canada</li>
    </ul>
  </div>
</div>`} />
...
<ComponentShowcase title="Color Variants" code={`<div class="autocomplete autocomplete-primary">
  <input name="primary-autocomplete" class="autocomplete-input" placeholder="Primary autocomplete..." aria-label="Primary autocomplete" />
  <ul class="autocomplete-dropdown">
    <li class="autocomplete-item">Option 1</li>
    <li class="autocomplete-item">Option 2</li>
  </ul>
</div>
<div class="autocomplete autocomplete-secondary">
  <input name="secondary-autocomplete" class="autocomplete-input" placeholder="Secondary autocomplete..." aria-label="Secondary autocomplete" />
</div>
<div class="autocomplete autocomplete-tertiary">
  <input name="tertiary-autocomplete" class="autocomplete-input" placeholder="Tertiary autocomplete..." aria-label="Tertiary autocomplete" />
</div>
<div class="autocomplete autocomplete-info">
  <input name="info-autocomplete" class="autocomplete-input" placeholder="Info autocomplete..." aria-label="Info autocomplete" />
</div>
<div class="autocomplete autocomplete-success">
  <input name="success-autocomplete" class="autocomplete-input" placeholder="Success autocomplete..." aria-label="Success autocomplete" />
</div>
<div class="autocomplete autocomplete-warning">
  <input name="warning-autocomplete" class="autocomplete-input" placeholder="Warning autocomplete..." aria-label="Warning autocomplete" />
</div>
<div class="autocomplete autocomplete-error">
  <input name="error-autocomplete" class="autocomplete-input" placeholder="Error autocomplete..." aria-label="Error autocomplete" />
</div>`}>
  <div class="autocomplete autocomplete-primary">
    <input name="primary-autocomplete" class="autocomplete-input" placeholder="Primary autocomplete..." aria-label="Primary autocomplete" />
  </div>
  <div class="autocomplete autocomplete-secondary">
    <input name="secondary-autocomplete" class="autocomplete-input" placeholder="Secondary autocomplete..." aria-label="Secondary autocomplete" />
...
<ComponentShowcase title="Ghost Autocomplete" code={`<div class="autocomplete autocomplete-ghost">
  <input name="ghost-autocomplete" class="autocomplete-input" placeholder="Ghost autocomplete (no border)..." aria-label="Ghost autocomplete" />
</div>`}>
  <div class="autocomplete autocomplete-ghost">
    <input name="ghost-autocomplete" class="autocomplete-input" placeholder="Ghost autocomplete (no border)..." aria-label="Ghost autocomplete" />
  </div>
</ComponentShowcase>
...
- [Chip](/duskmoonui/docs/en/components/chip/) - Selected items display
