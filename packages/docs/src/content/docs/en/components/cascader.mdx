...
<ComponentShowcase title="Cascader with Search" code={`<div class="cascader">
  ...
  <div class="cascader-dropdown" id="cascader-search" popover="auto">
    <div class="cascader-search">
      <input type="text" name="cascader-search" class="cascader-search-input" placeholder="Search..." aria-label="Search locations" />
    </div>
    <div class="cascader-panels">
      <div class="cascader-panel">
        <div class="cascader-options">
...
<ComponentShowcase title="Error State" code={`<div class="form-group">
  <span class="form-label form-label-required">Location</span>
...
<ComponentShowcase title="Color Variants" code={`<div class="cascader cascader-primary">
  <button class="cascader-trigger">Primary Cascader</button>
</div>
<div class="cascader cascader-secondary">
  <button class="cascader-trigger">Secondary Cascader</button>
</div>
<div class="cascader cascader-tertiary">
  <button class="cascader-trigger">Tertiary Cascader</button>
</div>
<div class="cascader cascader-info">
  <button class="cascader-trigger">Info Cascader</button>
</div>
<div class="cascader cascader-success">
  <button class="cascader-trigger">Success Cascader</button>
</div>
<div class="cascader cascader-warning">
  <button class="cascader-trigger">Warning Cascader</button>
</div>
<div class="cascader cascader-error">
  <button class="cascader-trigger">Error Cascader</button>
</div>`}>
  <div class="cascader cascader-primary">
    <button class="cascader-trigger">Primary Cascader</button>
  </div>
  <div class="cascader cascader-secondary">
    <button class="cascader-trigger">Secondary Cascader</button>
...
<ComponentShowcase title="Ghost Cascader" code={`<div class="cascader cascader-ghost">
  <button class="cascader-trigger">Ghost Cascader (no border)</button>
</div>`}>
  <div class="cascader cascader-ghost">
    <button class="cascader-trigger">Ghost Cascader (no border)</button>
  </div>
</ComponentShowcase>
