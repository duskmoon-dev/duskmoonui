...
Alerts communicate important inline information. They do not announce or dismiss themselves; use an appropriate live-region policy and an accessible button when application state requires it.

The default layout keeps the icon and title/content row together, with `.alert-actions` aligned at the end of that row. Add `.alert-actions-bottom` to place actions below the content instead; `.alert-actions-end` explicitly selects the end-aligned layout. On narrow screens, actions move below the content automatically. Use `.alert-horizontal` or `.alert-vertical` when layout should be explicit. Prefer logical layout and action content so the same markup works in RTL.
...
<ComponentShowcase title="Complete Alert Structure" code={`<div class="alert alert-info">
  ...
  <div class="alert-actions">
    <button class="btn btn-sm btn-outlined">Learn More</button>
  </div>
...
<ComponentShowcase title="Alert with Actions" code={`<div class="alert alert-error">
  ...
  <div class="alert-actions">
    <button class="btn btn-sm btn-outlined">Dismiss</button>
    <button class="btn btn-sm btn-primary">Update Payment</button>
  </div>
</div>`} />

Use `.alert-actions-bottom` when actions should always occupy a separate row:

<ComponentShowcase title="Alert with Bottom Actions" code={`<div class="alert alert-info alert-actions-bottom">
  <div class="alert-icon" aria-hidden="true">ⓘ</div>
  <div class="alert-content">
    <h4 class="alert-title">Review required</h4>
    <p class="alert-description">Please review the latest account changes.</p>
  </div>
  <div class="alert-actions">
    <button class="btn btn-sm btn-outlined">Dismiss</button>
...
<ComponentShowcase title="Feature Announcement Alert" code={`<div class="alert alert-filled alert-info">
  ...
  <div class="alert-actions">
    <button class="btn btn-sm btn-outlined">Try It Now</button>
  </div>
</div>`} />
...
<ComponentShowcase title="Alert with Next Steps" code={`<div class="alert alert-warning">
  ...
  <div class="alert-actions">
    <button class="btn btn-sm btn-outlined">Stay Logged In</button>
  </div>
</div>`} />
