...
### Info
<ComponentShowcase title="Info Segment Control" code={`<div class="segment-control segment-control-info">
  <button class="segment-item segment-item-active">Tab 1</button>
  <button class="segment-item">Tab 2</button>
  <button class="segment-item">Tab 3</button>
</div>`}>
  <div class="segment-control segment-control-info">
    <button class="segment-item segment-item-active">Tab 1</button>
    <button class="segment-item">Tab 2</button>
    <button class="segment-item">Tab 3</button>
  </div>
...
### Success
<ComponentShowcase title="Success Segment Control" code={`<div class="segment-control segment-control-success">
  <button class="segment-item segment-item-active">Tab 1</button>
  <button class="segment-item">Tab 2</button>
  <button class="segment-item">Tab 3</button>
</div>`}>
  <div class="segment-control segment-control-success">
    <button class="segment-item segment-item-active">Tab 1</button>
    <button class="segment-item">Tab 2</button>
    <button class="segment-item">Tab 3</button>
  </div>
...
### Warning
<ComponentShowcase title="Warning Segment Control" code={`<div class="segment-control segment-control-warning">
  <button class="segment-item segment-item-active">Tab 1</button>
  <button class="segment-item">Tab 2</button>
  <button class="segment-item">Tab 3</button>
</div>`}>
  <div class="segment-control segment-control-warning">
    <button class="segment-item segment-item-active">Tab 1</button>
    <button class="segment-item">Tab 2</button>
    <button class="segment-item">Tab 3</button>
  </div>
...
### Error
<ComponentShowcase title="Error Segment Control" code={`<div class="segment-control segment-control-error">
  <button class="segment-item segment-item-active">Tab 1</button>
  <button class="segment-item">Tab 2</button>
  <button class="segment-item">Tab 3</button>
</div>`}>
  <div class="segment-control segment-control-error">
    <button class="segment-item segment-item-active">Tab 1</button>
    <button class="segment-item">Tab 2</button>
    <button class="segment-item">Tab 3</button>
  </div>
...
<ComponentShowcase title="Ghost Segment Control" code={`<div class="segment-control segment-control-ghost">
  <button class="segment-item segment-item-active">Tab 1</button>
  <button class="segment-item">Tab 2</button>
  <button class="segment-item">Tab 3</button>
</div>`}>
  <div class="segment-control segment-control-ghost">
    <button class="segment-item segment-item-active">Tab 1</button>
    <button class="segment-item">Tab 2</button>
    <button class="segment-item">Tab 3</button>
  </div>
