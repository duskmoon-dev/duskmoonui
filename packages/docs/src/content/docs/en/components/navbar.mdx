...
<!-- Extended palette -->
<nav class="navbar navbar-accent">Accent</nav>
<nav class="navbar navbar-neutral">Neutral</nav>
<nav class="navbar navbar-base">Base</nav>`} />
...
<ComponentShowcase title="Responsive Navbar with Native Menu" code={`<nav class="navbar navbar-responsive" aria-label="Main navigation">
  <div class="navbar-start">
    <a href="/" class="navbar-brand">Brand</a>
  </div>
  <div class="navbar-center">
    <a href="/" class="navbar-item" aria-current="page">Home</a>
    <a href="/about" class="navbar-item">About</a>
    <a href="/services" class="navbar-item">Services and consulting</a>
  </div>
  <div class="navbar-end">
    <button type="button" class="navbar-hamburger" aria-label="Open navigation"
      popovertarget="demo-navbar-mobile-menu"
      style="anchor-name: --demo-navbar-mobile-menu">
...
<ul id="demo-navbar-mobile-menu" class="menu menu-vertical" popover="auto"
  aria-label="Mobile navigation" style="position-anchor: --demo-navbar-mobile-menu">
  <li><a href="/" aria-current="page">Home</a></li>
  <li><a href="/about">About</a></li>
  <li><a href="/services">Services and consulting</a></li>
</ul>`} />

The center region is hidden below 48rem only when `.navbar-responsive` is present. The native popover owns open state, Escape handling, and light dismissal. `popovertarget` is the broad native trigger form; outside the supported Popover baseline, use a `details` disclosure or Drawer containing the same ordinary navigation links.
...
| `.navbar-responsive` | Hide the center region below 48rem and show the mobile trigger |
