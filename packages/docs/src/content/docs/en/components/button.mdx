...
## Composing action components

Button remains the visual foundation for action triggers. [Dropdown](/duskmoonui/docs/en/components/dropdown/) triggers and [FAB / Speed Dial](/duskmoonui/docs/en/components/fab/) actions compose `.btn` with their component-specific classes rather than copying button colors, focus, loading, or disabled behavior.

When using individual imports for a FAB, import both styles:
...
- [Dropdown](/duskmoonui/docs/en/components/dropdown/) - Button-triggered disclosures
- [FAB / Speed Dial](/duskmoonui/docs/en/components/fab/) - Floating actions composed with Button
- [Swap](/duskmoonui/docs/en/components/swap/) - State indicators that can compose with a button
