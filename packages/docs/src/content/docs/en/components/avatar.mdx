...
- [Badge](/docs/en/components/badge/) - Notification indicators that can be paired with avatars
- [Card](/docs/en/components/card/) - Container for user profiles with avatars
- [List](/docs/en/components/list/) - Lists with avatar items
