...
<ComponentShowcase
  ...
  code={`<div class="avatar">
  <img src="https://i.pravatar.cc/150?img=1" alt="User name" class="avatar-image" />
</div>`}
/>
...
<div class="avatar avatar-circle">
  <img src="https://i.pravatar.cc/150?img=2" alt="User" class="avatar-image" />
</div>

<!-- Rounded -->
<div class="avatar avatar-rounded">
  <img src="https://i.pravatar.cc/150?img=3" alt="User" class="avatar-image" />
</div>

<!-- Square -->
<div class="avatar avatar-square">
  <img src="https://i.pravatar.cc/150?img=4" alt="User" class="avatar-image" />
</div>`}
/>
...
<div class="avatar avatar-status avatar-status-online">
  <img src="https://i.pravatar.cc/150?img=5" alt="User" class="avatar-image" />
</div>

<!-- Offline -->
<div class="avatar avatar-status avatar-status-offline">
  <img src="https://i.pravatar.cc/150?img=6" alt="User" class="avatar-image" />
</div>

<!-- Busy -->
<div class="avatar avatar-status avatar-status-busy">
  <img src="https://i.pravatar.cc/150?img=7" alt="User" class="avatar-image" />
</div>

<!-- Away -->
<div class="avatar avatar-status avatar-status-away">
  <img src="https://i.pravatar.cc/150?img=8" alt="User" class="avatar-image" />
</div>`}
/>
...
<ComponentShowcase
  ...
  <img src="https://i.pravatar.cc/150?img=9" alt="User" class="avatar-image" />
</div>

<div class="avatar avatar-xl avatar-status avatar-status-busy">
  <img src="https://i.pravatar.cc/150?img=10" alt="User" class="avatar-image" />
</div>`}
/>
...
<ComponentShowcase
  ...
  <img src="https://i.pravatar.cc/150?img=11" alt="User" class="avatar-image" />
</div>
...
<ComponentShowcase
  ...
  <img src="https://i.pravatar.cc/150?img=13" alt="User profile" class="avatar-image" />
</button>

<!-- Or with a link -->
<a href="/profile" class="avatar avatar-clickable">
  <img src="https://i.pravatar.cc/150?img=14" alt="User profile" class="avatar-image" />
</a>`}
/>
...
<ComponentShowcase
  ...
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=15" alt="User 1" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=16" alt="User 2" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=17" alt="User 3" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=18" alt="User 4" class="avatar-image" />
  </div>
</div>`}
/>
...
<ComponentShowcase
  ...
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=19" alt="User 1" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=20" alt="User 2" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=21" alt="User 3" class="avatar-image" />
  </div>
</div>`}
/>
...
<div class="avatar-group avatar-group-sm">
  <div class="avatar avatar-sm">
    <img src="https://i.pravatar.cc/150?img=22" alt="User 1" class="avatar-image" />
  </div>
  <div class="avatar avatar-sm">
    <img src="https://i.pravatar.cc/150?img=23" alt="User 2" class="avatar-image" />
  </div>
  <div class="avatar avatar-sm">
    <img src="https://i.pravatar.cc/150?img=24" alt="User 3" class="avatar-image" />
  </div>
</div>
...
<div class="avatar-group avatar-group-lg">
  <div class="avatar avatar-lg">
    <img src="https://i.pravatar.cc/150?img=25" alt="User 1" class="avatar-image" />
  </div>
  <div class="avatar avatar-lg">
    <img src="https://i.pravatar.cc/150?img=26" alt="User 2" class="avatar-image" />
  </div>
  <div class="avatar avatar-lg">
    <img src="https://i.pravatar.cc/150?img=27" alt="User 3" class="avatar-image" />
  </div>
</div>`}
/>
...
<ComponentShowcase
  ...
  code={`<div class="avatar-group">
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=28" alt="User 1" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=29" alt="User 2" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=30" alt="User 3" class="avatar-image" />
  </div>
...
<ComponentShowcase
  ...
  <a href="/user/1" class="avatar avatar-clickable">
    <img src="https://i.pravatar.cc/150?img=31" alt="User 1" class="avatar-image" />
  </a>
  <a href="/user/2" class="avatar avatar-clickable">
    <img src="https://i.pravatar.cc/150?img=32" alt="User 2" class="avatar-image" />
  </a>
  <a href="/user/3" class="avatar avatar-clickable">
    <img src="https://i.pravatar.cc/150?img=33" alt="User 3" class="avatar-image" />
  </a>
</div>`}
/>
...
<div class="avatar">
  <img src="https://i.pravatar.cc/150?img=34" alt="User name" class="avatar-image" />
</div>`}
/>
...
<ComponentShowcase
  ...
  code={`<!-- Good -->
<div class="avatar">
  <img src="https://i.pravatar.cc/150?img=35" alt="John Doe" class="avatar-image" />
</div>

<!-- Better: include context -->
<div class="avatar">
  <img src="https://i.pravatar.cc/150?img=35" alt="John Doe, Senior Developer" class="avatar-image" />
</div>`}
/>
...
<ComponentShowcase
  ...
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=36" alt="Team member 1" class="avatar-image" />
  </div>
  <div class="avatar">
    <img src="https://i.pravatar.cc/150?img=37" alt="Team member 2" class="avatar-image" />
  </div>
</div>`}
/>
...
// Usage
<Avatar src="https://i.pravatar.cc/150?img=46" alt="John Doe" size="lg" status="online" />
...
<AvatarGroup max={3} size="md">
  <Avatar src="https://i.pravatar.cc/150?img=41" alt="User 1" />
  <Avatar src="https://i.pravatar.cc/150?img=42" alt="User 2" />
  <Avatar src="https://i.pravatar.cc/150?img=43" alt="User 3" />
  <Avatar src="https://i.pravatar.cc/150?img=44" alt="User 4" />
  <Avatar src="https://i.pravatar.cc/150?img=45" alt="User 5" />
</AvatarGroup>
```
...
<div class="avatar avatar-lg avatar-rounded avatar-primary avatar-status avatar-status-online avatar-bordered">
  <img src="https://i.pravatar.cc/150?img=39" alt="User" class="avatar-image" />
</div>
...
<button class="avatar avatar-sm avatar-square avatar-clickable avatar-status avatar-status-busy">
  <img src="https://i.pravatar.cc/150?img=40" alt="User" class="avatar-image" />
</button>`}
/>
