...
- [Input](/docs/en/components/input/) - Text and number inputs
- [Select](/docs/en/components/select/) - Dropdown selections
- [Switch](/docs/en/components/switch/) - Toggle controls
