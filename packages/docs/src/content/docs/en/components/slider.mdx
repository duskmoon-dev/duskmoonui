...
### Info
<ComponentShowcase title="Info Slider" code={`<div class="slider slider-info">
  <div class="slider-track">
    <div class="slider-track-filled" style="width: 50%;"></div>
  </div>
...
### Success
<ComponentShowcase title="Success Slider" code={`<div class="slider slider-success">
  <div class="slider-track">
    <div class="slider-track-filled" style="width: 80%;"></div>
  </div>
...
### Warning
<ComponentShowcase title="Warning Slider" code={`<div class="slider slider-warning">
  <div class="slider-track">
    <div class="slider-track-filled" style="width: 65%;"></div>
  </div>
...
### Error
<ComponentShowcase title="Error Slider" code={`<div class="slider slider-error">
  <div class="slider-track">
...
<ComponentShowcase title="Accessible Slider" code={`<span id="volume-slider-label">Volume</span>
<div
  id="volume-slider"
  class="slider"
  role="slider"
