...
### Status Variants
<ComponentShowcase title="Status Color Variants" code={`<button class="toggle-btn toggle-btn-info toggle-btn-active">Info Active</button>
<button class="toggle-btn toggle-btn-success toggle-btn-active">Success Active</button>
<button class="toggle-btn toggle-btn-warning toggle-btn-active">Warning Active</button>
<button class="toggle-btn toggle-btn-error toggle-btn-active">Error Active</button>`}>
  <div class="flex gap-2 flex-wrap">
    <button class="toggle-btn toggle-btn-info toggle-btn-active">Info Active</button>
    <button class="toggle-btn toggle-btn-success toggle-btn-active">Success Active</button>
    <button class="toggle-btn toggle-btn-warning toggle-btn-active">Warning Active</button>
    <button class="toggle-btn toggle-btn-error toggle-btn-active">Error Active</button>
  </div>
...
- [Checkbox](/duskmoonui/docs/en/components/checkbox/) - Multi-select form inputs
- [Radio](/duskmoonui/docs/en/components/radio/) - Single-select form inputs
- [Switch](/duskmoonui/docs/en/components/switch/) - Binary on/off toggle
