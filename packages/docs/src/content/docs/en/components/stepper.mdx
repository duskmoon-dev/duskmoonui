...
- [Tabs](/docs/en/components/tabs/) - Alternative navigation pattern
- [Breadcrumb](/docs/en/components/breadcrumb/) - Hierarchical navigation
- [Progress](/docs/en/components/progress/) - Linear progress indicator
- [Button](/docs/en/components/button/) - Action buttons for navigation
